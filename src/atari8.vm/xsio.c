...
BYTE Bin1[128] = {
    ...
    0x08, 0x88, 0xD0, 0xFA, 0xC8, 0x84, 0x09, 0x8C, 0x01, 0x03, 0xCE, 0x06, 0x03, 0xea, 0xea, 0xea, // leaves DL alone (bombjack)
    0xea, 0xea, 0xea, 0xea, 0xea, 0xea, 0xea, 0xA9, 0x69, 0x85, 0x18, 0xEA, 0xEA, 0xEA, 0xEA, 0xEA, // leaves DL alone (bombjack)
