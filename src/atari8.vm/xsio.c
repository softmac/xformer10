...
const BYTE Bas1[128] = {    // ca fe @$10 is our signature so we know to use BASIC
 ...
 0x03, 0xA9, 0x04, 0x8D, 0x0A, 0x03, 0xA9, 0x40, 0x8D, 0x03, 0x03, 0x20, 0x59, 0xE4, 0xAD, 0x03,
...
// this old attempt to run a BASIC program w/o DOS by loading a tokenized file by hand failed
BYTE Bas1[128] = {
